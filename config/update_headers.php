...
function updateHeadersRecursively($dir, $header_replacement) {
    ...
    foreach ($iterator as $file) {
        if ($file->isFile() && $file->getExtension() === 'php') {
            ...
            // Skip vendor or .git directories
            ...
            // Perform regex replace matching     <header class="dash-header">
        <div class="header-left">
            <button class="menu-toggle-btn" id="btnMenuToggle" aria-label="Toggle Menu">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <line x1="3" y1="12" x2="21" y2="12"></line>
        ...
        <div class="header-profile-group">
            ...
            $new_content = preg_replace('/<header class="dash-header">.*?<\/header>/s', $header_replacement, $content);
            
            if ($new_content !== null && $new_content !== $content) {
                file_put_contents($path, $new_content);
                echo "Updated header in: " . $path . PHP_EOL;
            }
        }
    }
}

updateHeadersRecursively(dirname(__DIR__), $header_replacement);
echo "Header update processing complete." . PHP_EOL;
?>
