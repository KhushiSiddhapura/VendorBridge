            ...
            <nav class="sidebar-nav">
                <ul>
                    <?php if ($_SESSION['role'] === 'vendor'): ?>
                        <li><a href="../../vendorDashboard/vendorDashboard.php"><span class="nav-icon">📊</span> Dashboard</a></li>
                    <?php else: ?>
                        ...
                        <li class="active"><a href="./invoices.php"><span class="nav-icon">🧾</span> Invoices</a></li>
